...
const SurveyNavigation = ({ 
    ...
    return (
        <div className="flex justify-between items-center">
            <button
                onClick={onPrevious}
                className="flex items-center gap-1 sm:gap-2 px-3 sm:px-6 py-2 bg-pink-100 text-pink-700 rounded-full hover:bg-pink-200 transition-colors text-sm sm:text-base"
            >
                <ArrowLeft size={16} />
                Previous
            </button>
